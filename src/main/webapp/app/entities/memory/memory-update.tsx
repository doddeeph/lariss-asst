  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="larissAsstApp.memory.home.createOrEditLabel" data-cy="MemoryCreateUpdateHeading">
            <Translate contentKey="larissAsstApp.memory.home.createOrEditLabel">Create or edit a Memory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('larissAsstApp.memory.name')}
                id="memory-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField label={translate('larissAsstApp.memory.value')} id="memory-value" name="value" data-cy="value" type="text" />
