...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STRAPCOLOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STRAPCOLOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STRAPCOLOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STRAPCOLOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STRAPCOLOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STRAPCOLOR actions', async () => {
      const arg = 42666;
