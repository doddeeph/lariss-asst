...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './billing.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BILLING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BILLING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BILLING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BILLING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BILLING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BILLING actions', async () => {
      const arg = 42666;
