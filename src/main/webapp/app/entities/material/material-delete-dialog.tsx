...
export const MaterialDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/material${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="larissAsstApp.material.delete.question">
        <Translate contentKey="larissAsstApp.material.delete.question" interpolate={{ id: materialEntity.id }}>
