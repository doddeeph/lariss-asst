  ...
  return (
    <div>
      <h2 id="storage-heading" data-cy="StorageHeading">
        <Translate contentKey="larissAsstApp.storage.home.title">Storages</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="larissAsstApp.storage.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/storage/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="larissAsstApp.storage.home.createLabel">Create new Storage</Translate>
          </Link>
        </div>
      </h2>
        ...
        {storageList && storageList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="larissAsstApp.storage.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="larissAsstApp.storage.home.notFound">No Storages found</Translate>
            </div>
          )
        )}
      </div>
