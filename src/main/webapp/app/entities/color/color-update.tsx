  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="larissAsstApp.color.home.createOrEditLabel" data-cy="ColorCreateUpdateHeading">
            <Translate contentKey="larissAsstApp.color.home.createOrEditLabel">Create or edit a Color</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('larissAsstApp.color.name')}
                id="color-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField label={translate('larissAsstApp.color.value')} id="color-value" name="value" data-cy="value" type="text" />
