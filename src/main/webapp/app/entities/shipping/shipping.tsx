  ...
  return (
    <div>
      <h2 id="shipping-heading" data-cy="ShippingHeading">
        <Translate contentKey="larissAsstApp.shipping.home.title">Shippings</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="larissAsstApp.shipping.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/shipping/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="larissAsstApp.shipping.home.createLabel">Create new Shipping</Translate>
          </Link>
        </div>
      </h2>
        ...
        {shippingList && shippingList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="larissAsstApp.shipping.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
            ...
            <tbody>
              {shippingList.map((shipping, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`larissAsstApp.ShippingMethod.${shipping.method}`} />
                  </td>
                  <td>{shipping.cost}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="larissAsstApp.shipping.home.notFound">No Shippings found</Translate>
            </div>
          )
        )}
      </div>
