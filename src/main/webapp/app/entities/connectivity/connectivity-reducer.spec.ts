...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONNECTIVITY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CONNECTIVITY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CONNECTIVITY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CONNECTIVITY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CONNECTIVITY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CONNECTIVITY actions', async () => {
      const arg = 42666;
