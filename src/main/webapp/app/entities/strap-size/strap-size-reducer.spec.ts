...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STRAPSIZE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STRAPSIZE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STRAPSIZE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STRAPSIZE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STRAPSIZE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STRAPSIZE actions', async () => {
      const arg = 42666;
