...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './case-size.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CASESIZE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CASESIZE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CASESIZE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CASESIZE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CASESIZE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CASESIZE actions', async () => {
      const arg = 42666;
