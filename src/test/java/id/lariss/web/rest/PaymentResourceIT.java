...
import static id.lariss.domain.PaymentAsserts.*;
...
class PaymentResourceIT {
    ...
    private static final PaymentMethod UPDATED_PAYMENT_METHOD = PaymentMethod.BANK_TRANSFER;
    ...
    void partialUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.paymentMethod(UPDATED_PAYMENT_METHOD).cvv(UPDATED_CVV);
