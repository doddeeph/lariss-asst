...
import id.lariss.repository.OrderItemRepository;
import id.lariss.service.dto.OrderItemDTO;
import id.lariss.service.mapper.OrderItemMapper;
...
class OrderItemResourceIT {
    ...
    public static OrderItem createEntity() {
        return new OrderItem().quantity(DEFAULT_QUANTITY).totalPrice(DEFAULT_TOTAL_PRICE);
    }
    ...
    public static OrderItem createUpdatedEntity() {
        return new OrderItem().quantity(UPDATED_QUANTITY).totalPrice(UPDATED_TOTAL_PRICE);
    }
